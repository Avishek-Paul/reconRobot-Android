...
public class JoystickView extends SurfaceView implements SurfaceHolder.Callback, View.OnTouchListener
{
    ...
    private void drawJoystick(float newX, float newY)
    {
        if(getHolder().getSurface().isValid())
        {
            ...
            myCanvas.drawColor(Color.TRANSPARENT, PorterDuff.Mode.MULTIPLY); // Clear the BG
...
//                colors.setARGB(255, (int) (i * (255 * ratio / hatRadius)), (int) (i * (255 * ratio / hatRadius)), 255); //Change the joystick color for shading purposes
    ...
    public boolean onTouch(View v, MotionEvent e)
    {
        if(v.equals(this))
        {
            if(e.getAction() != e.ACTION_UP)
            {
                ...
                joystickCallback.getJoystickPosition(e.getX(), e.getY(), centerX, centerY,true);
                ...
                drawJoystick(centerX, centerY);
                joystickCallback.getJoystickPosition(e.getX(), e.getY(), centerX, centerY,false);
            }
    ...
    public interface JoystickListener
    {
        ...
        void getJoystickPosition(float x, float y, float cx, float cy, boolean active);
    }
}